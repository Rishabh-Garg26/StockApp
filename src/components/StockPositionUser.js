...
import { ActivityIndicator, TextInput, DataTable } from "react-native-paper";
    ...
    return (
      <>
        <DataTable.Row key={row.id}>
          ...
          <DataTable.Cell>
            {row.gatePassDate
              ? moment(row.gatePassDate).format("DD/MM/YYYY")
              : ""}
          </DataTable.Cell>
      ...
      <ScrollView automaticallyAdjustKeyboardInsets={true}>
        ...
        <View style={styles.container}>
          ...
          >
            ...
            >
              <Text style={{ color: "white", fontSize: 30 }}>Preview</Text>
            </Pressable>
            ...
            >
              <Text style={{ color: "white", fontSize: 30 }}>Download</Text>
            </Pressable>
          </View>
        </View>
